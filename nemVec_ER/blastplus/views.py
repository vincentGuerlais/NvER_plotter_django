...
from ER_plotter.forms import Gene_searchForm, NvERTxForm
...
def blast(request, blast_form, template_init, template_result, blast_commandline, sample_fasta_path,
        ...
        if form.is_valid():
            ...
            try:
                ...
                if len(blast_error) > 0:
                    ...
                    return render(request=request, template_name=template_result,
                                  context={'nvertx_form': nvertx_form, 'gene_search_form': gene_search_form,
    ...
    return render(request=request, template_name=template_init,
                  context={'form': form, 'nvertx_form': nvertx_form, 'gene_search_form': gene_search_form, 'sequence_sample_in_fasta': utils.get_sample_data(sample_fasta_path),

...
class Regen_cpm(models.Model) :
	nvertx_id = models.CharField(max_length=20,primary_key=True)
	regen_anc_UC = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_0HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_2HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_4HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_8HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_12HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_16HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_20HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_24HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_36HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_48HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_60HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_72HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_96HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_120HPA = models.FloatField(max_length=10,null=True,blank=True)
	regen_anc_144HPA = models.FloatField(max_length=10,null=True,blank=True)
	def __str__(self) :
		return self.nvertx_id
